...
public class CategoryTests
{
    ...
    public void GetById_CategoryNotFoundException(int categoryId)
    {
        ...
        var ex = Assert.ThrowsException<CategoryNotFoundException>(
    ...
    [DataRow(4, 1, 10)]
    [DataRow(12, 1, 10)]
    public void GetByUserIdPaged_NoCategoriesFound_ThrowsException(
        int userId,
        int page,
        int pageSize
    )
    ...
    public void Edit_CategoryNotFound_ReturnsFalse()
    {
        ...
        var repoMock = new Mock<ICategoryRepository>();
        repoMock
            .Setup(r => r.Edit(It.IsAny<Category>()))
            .Throws(new CategoryNotFoundException("Not found"));
        var service = new CategoryService(repoMock.Object, loggerMock.Object);
