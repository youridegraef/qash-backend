...
public class BudgetTests
{
    ...
    public void GetByCategoryId_IdZeroOrNegative_ThrowsException(int categoryId)
    {
        ...
        var categoryServiceMock = new Mock<ICategoryService>();
        repoMock
            .Setup(r => r.FindByCategoryId(categoryId))
    ...
    public void GetByCategoryId_BudgetNotFoundException(int categoryId)
    {
        ...
        var ex = Assert.ThrowsException<BudgetNotFoundException>(
    ...
    [DataRow("   ", "2025-12-31", "2026-12-31", 1000, 1)]
    public void Add_NameIsEmpty_ThrowsInvalidDataException(
        string name,
        string startDateStr,
        string endDateStr,
        double target,
    ...
    public void Edit_BudgetNotFound_ReturnsFalse()
    {
        ...
        var categoryServiceMock = new Mock<ICategoryService>();
        repoMock
            .Setup(r => r.Edit(It.IsAny<Budget>()))
            .Throws(new BudgetNotFoundException("Not found"));
        var service = new BudgetService(
            repoMock.Object,
            categoryServiceMock.Object,
            loggerMock.Object
